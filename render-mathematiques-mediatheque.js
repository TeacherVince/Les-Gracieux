/* Les Gracieux — génère la médiathèque de vidéos Mathématiques à partir de
   mathematiques-mediatheque-data.js.

   Fonctionnement :
   - 16 catégories fixes (Numération, Addition et soustraction,
     Multiplication, Tables de multiplication, Techniques de
     multiplication, Calcul mental, Résolution de problèmes, Longueurs,
     Masses, Contenances, Heure et durées, Géométrie, Figures
     géométriques, Symétrie, Aire et périmètre, Repérage dans l'espace),
...
(function () {
  ...
  var FAVORITES_KEY = "lg-mathematiques-favoris";

  var CATEGORIES = [
    { key: "Numération", label: "Numération", icon: "🔢" },
    { key: "Addition et soustraction", label: "Addition et soustraction", icon: "➕" },
    { key: "Multiplication", label: "Multiplication", icon: "✖️" },
    { key: "Tables de multiplication", label: "Tables de multiplication", icon: "📊" },
    { key: "Techniques de multiplication", label: "Techniques de multiplication", icon: "🧮" },
    { key: "Calcul mental", label: "Calcul mental", icon: "🧠" },
    { key: "Résolution de problèmes", label: "Résolution de problèmes", icon: "🧩" },
    { key: "Longueurs", label: "Longueurs", icon: "📏" },
    { key: "Masses", label: "Masses", icon: "⚖️" },
    { key: "Contenances", label: "Contenances", icon: "🥤" },
    { key: "Heure et durées", label: "Heure et durées", icon: "🕐" },
    { key: "Géométrie", label: "Géométrie", icon: "📐" },
    { key: "Figures géométriques", label: "Figures géométriques", icon: "🔺" },
    { key: "Symétrie", label: "Symétrie", icon: "🦋" },
    { key: "Aire et périmètre", label: "Aire et périmètre", icon: "🟩" },
    { key: "Repérage dans l'espace", label: "Repérage dans l'espace", icon: "🧭" }
  ];
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var data = window.MATHEMATIQUES_MEDIATHEQUE_DATA;
