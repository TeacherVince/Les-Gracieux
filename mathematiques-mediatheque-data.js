/* =======================================================================
   MÉDIATHÈQUE MATHÉMATIQUES — Les Gracieux
   -----------------------------------------------------------------------
   Vidéos de révision en mathématiques, organisées par catégorie et
   affichées sur mathematiques-mediatheque.html. Ces vidéos viennent du
   site maitrelucas.fr : on ne les héberge pas nous-mêmes (elles ne sont
   pas libres de droit), chaque carte ouvre la leçon d'origine dans un
   nouvel onglet. L'auteur autorise explicitement le partage de ses liens.

   Pour AJOUTER une vidéo : copie un bloc { ... } ci-dessous, colle-le
   avant le "];" final de sa catégorie, et renseigne :

   id       : un identifiant unique (ex. "math-geo-9").
   category : exactement l'une de ces valeurs : "Numération",
              "Addition et soustraction", "Multiplication",
              "Tables de multiplication", "Techniques de multiplication",
              "Calcul mental", "Résolution de problèmes", "Longueurs",
              "Masses", "Contenances", "Heure et durées", "Géométrie",
              "Figures géométriques", "Symétrie", "Aire et périmètre",
              "Repérage dans l'espace" (détermine la section dans
              laquelle la vidéo apparaît).
   title    : le titre affiché sur la carte.
   url      : l'adresse complète de la leçon (avec https://).
   image    : l'adresse de la vignette (utilise l'image de la page de la
              leçon, généralement au format 1280x720).

   N'oublie pas la virgule après le bloc précédent.
   ======================================================================= */

window.MATHEMATIQUES_MEDIATHEQUE_DATA = [
  ...
  },
  {
    id: "math-tables-3",
    category: "Tables de multiplication",
    title: "La table de 2 et la table de 4",
    url: "https://maitrelucas.fr/lecons/la-table-de-2-et-la-table-de-4/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-2-et-de-4.png"
  },
  {
    id: "math-tables-4",
    category: "Tables de multiplication",
    title: "La table de 3",
    url: "https://maitrelucas.fr/lecons/table-de-3/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-3-1.png"
  },
  {
    id: "math-tables-5",
    category: "Tables de multiplication",
    title: "La table de 5",
    url: "https://maitrelucas.fr/lecons/la-table-de-5/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-5.png"
  },
  {
    id: "math-tables-6",
    category: "Tables de multiplication",
    title: "La table de 6",
    url: "https://maitrelucas.fr/lecons/table-de-6/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-6-1.png"
  },
  {
    id: "math-tables-7",
    category: "Tables de multiplication",
    title: "La table de 7",
    url: "https://maitrelucas.fr/lecons/la-table-de-7/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-7-1.png"
  },
  {
    id: "math-tables-8",
    category: "Tables de multiplication",
    title: "La table de 8",
    url: "https://maitrelucas.fr/lecons/la-table-de-8/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-8.png"
  },
  {
    id: "math-tables-9",
    category: "Tables de multiplication",
    title: "La table de 9",
    url: "https://maitrelucas.fr/lecons/la-table-de-9/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-9-1.png"
  },
  {
    id: "math-tables-10",
    category: "Tables de multiplication",
    title: "La table de 10",
    url: "https://maitrelucas.fr/lecons/la-table-de-10/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/table-de-10-hatier.png"
  },
  ...
  /* --------------------- Techniques de multiplication -------------------- */
  {
    ...
    url: "https://maitrelucas.fr/lecons/multiplier-par-10-100-1000/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/multiplier-par-10-100-1000.png"
  },
  {
    id: "math-techmult-2",
    category: "Techniques de multiplication",
  ...
  /* ---------------------------- Calcul mental ---------------------------- */
  {
    id: "math-calcmental-1",
    category: "Calcul mental",
    title: "Calcul mental",
    url: "https://maitrelucas.fr/lecons/calcul-mental-cp-ce1-ce2-cm1-cm2/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/calcul-mental-1.png"
  },
  {
    id: "math-calcmental-2",
    category: "Calcul mental",
    title: "Doubles et moitiés jusqu'à 100",
    url: "https://maitrelucas.fr/lecons/doubles-moities-jusqu-a-100/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/doubles-et-moities-jusqua-100.png"
  },
  ...
  /* ----------------------------- Longueurs -------------------------------- */
  {
    id: "math-longueurs-1",
    category: "Longueurs",
    title: "Mesurer avec une règle en centimètres et millimètres",
    url: "https://maitrelucas.fr/lecons/mesurer-avec-une-regle-cp-ce1-ce2/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/mesurer-avec-la-regle.png"
  },
  {
    id: "math-longueurs-2",
    category: "Longueurs",
  ...
  },
  {
    id: "math-longueurs-3",
    category: "Longueurs",
    title: "Mètre et kilomètre",
    url: "https://maitrelucas.fr/lecons/metre-kilometre-m-km-ce1-ce2/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/metre-et-kilometre-1.png"
  },
  ...
  /* ------------------------------- Masses --------------------------------- */
  {
    id: "math-masses-1",
    category: "Masses",
    title: "Les unités de mesure de masses",
    url: "https://maitrelucas.fr/lecons/les-unites-de-mesure-de-masses/",
    image: "https://maitrelucas.b-cdn.net/wp-content/uploads/unites-de-mesure-de-masses.png"
  },
  {
    id: "math-masses-2",
    category: "Masses",
